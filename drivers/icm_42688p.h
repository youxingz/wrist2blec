...
#define GYRO     0 // GYRO: indicate only set gyroscope
#define ACCEL    1 // ACCEL: indicate only set accelerometer
#define ALL      5 // ALL: indicate all of gyroscope and accelerometer
...
#define ODR_32KHZ         1  // ODR_32KHZ         Support: Gyro/Accel(LN mode)
#define ODR_16KHZ         2  // ODR_16KHZ         Support: Gyro/Accel(LN mode)
#define ODR_8KHZ          3  // ODR_8KHZ          Support: Gyro/Accel(LN mode)
#define ODR_4KHZ          4  // ODR_4KHZ          Support: Gyro/Accel(LN mode)
#define ODR_2KHZ          5  // ODR_2KHZ          Support: Gyro/Accel(LN mode)
#define ODR_1KHZ          6  // ODR_1KHZ          Support: Gyro/Accel(LN mode)
#define ODR_200HZ         7  // ODR_200HZ         Support: Gyro/Accel(LP or LN mode)
#define ODR_100HZ         8  // ODR_100HZ         Support: Gyro/Accel(LP or LN mode)
#define ODR_50HZ          9  // ODR_50HZ          Support: Gyro/Accel(LP or LN mode)
#define ODR_25KHZ         10 // ODR_25KHZ         Support: Gyro/Accel(LP or LN mode)
#define ODR_12_5KHZ       11 // ODR_12_5KHZ       Support: Gyro/Accel(LP or LN mode)
#define ODR_6_25KHZ       12 // ODR_6_25KHZ       Support: Accel(LP mode)
#define ODR_3_125HZ       13 // ODR_3_125HZ       Support: Accel(LP mode)
#define ODR_1_5625HZ      14 // ODR_1_5625HZ      Support: Accel(LP mode)
#define ODR_500HZ         15 // ODR_500HZ         Support: Accel(LP or LN mode)

// FSR  Full-scale range
#define FSR_0             0 // FSR_0      Gyro:±2000dps   /   Accel: ±16g
#define FSR_1             1 // FSR_1      Gyro:±1000dps   /   Accel: ±8g
#define FSR_2             2 // FSR_2      Gyro:±500dps    /   Accel: ±4g
#define FSR_3             3 // FSR_3      Gyro:±250dps    /   Accel: ±2g
#define FSR_4             4 // FSR_4      Gyro:±125dps    /   Accel: not optional
#define FSR_5             5 // FSR_5      Gyro:±62.5dps   /   Accel: not optional
#define FSR_6             6 // FSR_6      Gyro:±31.25dps  /   Accel: not optional
#define FSR_7             7 // FSR_7      Gyro:±15.625dps /   Accel: not optional
